...
sbmt.addEventListener('click', function (e) {
    if (age.value < 18 || age.value > 99) {
        customAlert("The age must be a number between 18 and 100", 10000);

    }
    if (firstName.value.length > 20 || lastName.value.length > 20) {
        customAlert("Please enter less than 20 characters", 10000);
    }
...
function customAlert(msg, duration) {
    ...
    styler.setAttribute("style", "border: solid 3px blue; text-align:center; width:auto; height:auto; top:90%; left:40%; background-color:lightblue; color:black");
    styler.innerHTML = "<br/><h4>" + msg + "</h4>";
    setTimeout(function () {
